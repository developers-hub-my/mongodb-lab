...
Prerequisites, Docker lab setup, and loading the sample data. Start here on Day 0
to make sure your environment works before the session begins.
...
- **Setup problems**: see [Getting Started](01-getting-started/README.md)
- **How do I write this query?**: see [Exercises](02-exercises/README.md) for worked examples
  or [mongosh Cheatsheet](03-reference/01-mongosh-cheatsheet.md) for syntax
- **Is my production setup safe?**: see [Security Checklist](03-reference/02-security-checklist.md)
